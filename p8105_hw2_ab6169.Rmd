...
After cleaning and merging, the resulting dataset has  
`r nrow(merged_df)` observations, covering the years  
`r min(merged_df$year)` to `r max(merged_df$year)`.  
Key variables include `year`, `month`, `president`, `close`, and `unemployment`.  
